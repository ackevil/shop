...
<body class="indexbody">
    <form id="form1" action="/admin/dsze/saveDsze" method="POST">
        <!--头部-->
        ...
        <div class=" tab1 main-container mainbody " id="tab1">
                ...
                <div class="container-flud">
                	<div class="row" style="margin: 10px; ">
	                		<div class=" row form-group">
	                			...
	                			<div class="col-sm-2">
	                			<input type="hidden" name="dszeId" value="${dsze.dszeId}"/>
	                			<input type="text" name="dszeTotalFund" value="${dsze.dszeTotalFund}" placeholder="请输入整数" class="form-control" />
	                			...
	                			<div class="col-sm-2 ">
	                				 <div class="input-group date" id="datetimeStart">
	                				 	<input type="text" id="dszeLaunchTime" class="form-control" name="dszeLaunchTime" value="<fmt:formatDate value='${dsze.dszeLaunchTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" />
	                			...
	                			<div class="col-sm-2">
	                				<div class="input-group date" id="datetimeStop">
						                <input type="text" id="dszeStopTime" class="form-control" name="dszeStopTime" value="<fmt:formatDate value='${dsze.dszeStopTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" />
                			...
                			<div class="form-group row">
			                		...
			                		<div class="col-sm-3">
			                			...
			                			<input type="text" name="dszeName"value="${dsze.dszeName}" placeholder="请输入项目标题" class="form-control" />
			                		</div>
			                		<div class="form-control-static col-sm-1">状态</div>
			                		<div class="col-sm-2">
			                			<select class="form-control" name="dszeState">
											  <option value="0" ${dsze.dszeState==0?"selected='selected'":"" }>未发布</option>
											  <option value="1" ${dsze.dszeState==1?"selected='selected'":"" } >进行中</option>
											  <option value="2" ${dsze.dszeState==2?"selected='selected'":"" }>已结束</option>
										</select>
			                		</div>
                			</div>
                			<div class="form-group row">
			                		...
			                		<div class="col-sm-4">
			                			...
			                			<input type="text" id="file_url" value="${dsze.dszeMainPic}" name="dszeMainPic" class="form-control" readonly />
			                		</div>
			                		<div class="form-control-static col-sm-1 text-right" >图片预览</div>
			                		<div class="col-sm-2">
			                			<img id="mainPic" src="${dsze.dszeMainPic}" style="width: 100px; height: 100px;"/>
			                		</div>
                			</div>
                			<div class="form-group row">
                				...
                				<div class="col-sm-7">
                					<input id="dszeDetailInfo"  name="dszeDetailInfo" type="hidden" value="" />
            ...
            <div class="page-footer" style="text-align: center;">
                <div class="btn-wrap" style="position: static;">
                	<input type="hidden" name="dszeSuportNum" value="${dsze.dszeSuportNum}">
                	<input type="hidden" name="dszeRaised" value="${dsze.dszeRaised }">
                	<input type="hidden" name="dszeIsOrder" value="${dsze.dszeIsOrder==null?'false':dsze.dszeIsOrder }">
                    <input type="hidden" name="dszeIntime" value="<fmt:formatDate value='${dsze.dszeIntime }' pattern='yyyy-MM-dd HH:mm:ss'/>">
                    <input type="hidden" name="dszeOrderTime" value="<fmt:formatDate value='${dsze.dszeOrderTime }' pattern='yyyy-MM-dd HH:mm:ss'/>">
                    <input type="submit" name="btnSave" value="提交保存" id="btnSave" class="btn btn-primary"  onclick="$('#dszeDetailInfo').val(ue.getContent());"/>
                    <input type="button" onclick="window.location.href='<%=basePath %>admin/dsze/dszeList'" class="btn btn-primary " value="返回上一页"/>
                </div>
            </div>
        </div>
        <!--/右侧内容-->
...
$('#datetimeStart')
    .on('changeDate show', function(e) {
        ...
        $('#form1').bootstrapValidator('revalidateField', 'dszeLaunchTime');
});
$('#datetimeStop')
    .on('changeDate show', function(e) {
        // Revalidate the date when user change it
        $('#form1').bootstrapValidator('revalidateField', 'dszeStopTime');
});
