...
<div class="pagelist">
    ...
    <input type="hidden" value="<fmt:formatDate value='${dszeLaunchTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" name="dszeLaunchTime"/>
    <input type="hidden" value="<fmt:formatDate value='${dszeStopTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" name="dszeStopTime"/>
