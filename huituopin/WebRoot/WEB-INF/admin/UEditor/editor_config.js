...
(function () {
    ...
    UEDITOR_CONFIG = {
        ...
        catcherUrl: URL + "server/submit/net/getRemoteImage.ashx",             //处理远程图片抓取的地址
        localDomain: "baidu.com",                                        //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地
        imageManagerPath: URL + "server/submit/net/imageManager.ashx",       //图片在线浏览的处理地址
        ...
        snapscreenServerFile: URL + "server/upload/net/snapImgUp.ashx", //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ...
        messages: {
            ...
            snapScreenMsg: '截图上传失败，请检查你的Web服务器环境。 '
        },
