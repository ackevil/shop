...
<body class="indexbody">
	...
	<div class="main-container">
       <div id="floatHead" class="toolbar-wrap" style="background-color: rgb(244,245,249); margin-bottom: 20px;">
           	<form id="selectForm" action="<%=basePath%>admin/getAllLP" method="post">
            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade in active" id="selling">
                  <div class="totalCount">
                    ...
                    <a href="<%=basePath%>admin/lpUserAdd" class="btn btn-primary " style="float:right; color:#FFFFFF">+添加会员</a>
                  </div>
                  <div class="content_table table-hover" style="width:100%; margin-top:20px;">
                         <div class="table_thead">
                                ...
                                <div class="table_title" style="width:20%;"><span style="text-align: center;">积分</span> </div>
                          ...
                          <c:forEach items="${userList}" var="user">
                           	<div class="tab-content">
                          	 	<div class="table_title" style="width:20%;">
                          	 		<img width="50px" height="50px" src="<%=path%>/${user[0]}" >
                          	 	</div>
                                <div class="table_title"  style="width:20%; line-height: 50px">
                                	<span>${user[1]}</span>
                                </div >
                                <div class="table_title" style="width:20%; line-height: 50px" >
                                	<span style="text-align: left;">${user[2]}</span>
                                </div>
                                <div class="table_title" style="width:20%;line-height: 50px">
                                	<span style="text-align: center;">${user[3]}</span>
                                </div>
                                <div class="table_title"  style="width:20%;line-height: 50px">
                                	<span style="text-align: center;"><a style="color:#FFFFFF" href="<%=path%>/admin/lpDetailInfo?userId=${user[4]}" class="btn btn-primary">查看</a></span>
                                </div>
                            </div>
                          </c:forEach>
                  </div>
