		...
		<div class="main-container">
			<div class="mainbody">
				...
				<div class="location" style="height:30px;border-bottom: 0px;line-height: 30px">
					<a href="<%=path%>/admin/getAllPP" class="home"><i></i><span>所有会员</span></a>
						 ...
						 <tbody>
						    <tr><td  style="height: 55px;">
						      	<div style="margin-top: 6px;">
						      		...
						      		<input name="userPhone" type="text" id="userPhone" placeholder="请填电话号码">
						      	</div>
						    </td></tr>
						     ...
						     <tr><td  style="height: 55px;">
						      	<div style="margin-top: 6px;">
						      		...
						      		<input name="userName" type="text" id="userName" placeholder="请填姓名">
						      	</div>
						    </td></tr>
						    ...
						    <tr><td  style="height: 55px;">
						      	<div style="margin-top: 6px;">
						      		...
						      		<input name="userDetailAddr" style="width:300px;" type="text" id="userDetailAddr" placeholder="请填详细地址">
						      	</div>
						    </td></tr>
						    
						     <tr><td  style="height: 55px;">
						      	<div style="margin-top: 6px;">
						      		<label class="label-text">邮政编码</label>
						      		<input name="userPost" style="width:150px;" type="text" id="userPost" placeholder="请填邮政编码">
						      	</div>
						    </td></tr>
						    ...
						    <tr><td  style="height: 55px;">
						      	<div style="margin-top: 6px;">
						      		...
						      		<input name="userAge"   style="width:100px;" type="text" id="userAge" placeholder="请填年龄">
						      	</div>
						    </td></tr>
						    ...
						    <tr><td  style="height: 55px;">
						      	<div style="margin-top: 6px;">
						      		...
						      		<div style="width: 500px;height: 100%;display:inline">
									    <label class="checkbox-inline">
											<input style="width: 20px" type="radio" name="userSex" id="userSexMan" value="true" checked>男
										</label>
										<label class="checkbox-inline">
											<input style="width: 20px" type="radio" name="userSex" id="userSexWoman" value="false">女
										</label>
									</div>
								</div>
						    </td></tr>
						     ...
						     <tr><td  style="height: 55px;">
						      	<div style="margin-top: 6px;">
						      		...
						      		<select name="userType" id="userType" style="width: 80px">
