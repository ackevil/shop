...
<div class="pagelist">
    ...
    <input type="hidden" value="<fmt:formatDate value='${activityLaunchTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" name="activityLaunchTime"/>
    <input type="hidden" value="<fmt:formatDate value='${activityStopTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" name="activityStopTime"/>
