      ...
      <jsp:include page="../commonPage/commonLeft.jsp"/>
       ...
       <div class="container-fluid" style="background-color: rgb(244,245,249);padding-top:10px;padding-bottom:10px;">
       		<div class="row">
       			...
       			<div class="col-md-9 text-center">
       				<div class=" form-control-static" style="font-size:16px">修改商品</div>
       			</div>
       			<div class="col-md-2">
       				<button id="updateProduct" class="btn btn-primary">保存</button>
       			</div>
       		</div>
       </div>
       ...
       <div class="container-fluid" style="background-color: rgb(244,245,249);margin:10px">
       		<div class="row">
       			...
       			<div class="col-md-10">
       				<div class="row">
       					...
       					<input id="productName"  name="productName"  value="${product.productName }"type="text" placeholder="商品名称" class="form-control"/>
       					</div>
       				</div>
       				<div class="row">
       					<div class="col-md-3 text-right">
       						...
       						<select id="productCategoryId" name="productCategoryId" class="form-control">
       						 <c:if test="${not empty typeList}">
       						 	<c:forEach items="${typeList}" var="type">
       						 		<option value="${type.productTypeId}" ${product.productCategoryId == type.productTypeId ? "selected='selected'":""}>${type.productTypeName}</option>
       						 	</c:forEach>
       						 </c:if>
       				...
       				<div class="row">
       					...
       					<div class="col-md-3">
       						<input id="productPrice" name="productPrice" type="text"  value="${product.productPrice}" class="form-control"/>
       					</div>
       					<div class="col-md-1" >
       				...
       				<div class="row">
       					...
       					<div class="col-md-3">
       						<input id="productCredit" name="productCredit" value="${product.productCredit}" type="text" class="form-control"/>
       					</div>
       				</div>
       				<div class="row">
       					<div class="col-md-3 text-right">
       					...
       					<div class="col-md-3">
       						<img  id="mainPic" class="img-rounded"  src="${product.productMainpicPath}" style="height:140px;width: 140px"/>
       					</div>
       					<div class="col-md-3" >
       						<input type="file" id="file_upload" class="form-control"/>
       						<input type="text" id="productMainpicPath" value="${product.productMainpicPath}" placeholder="图片路径" name="productMainpicPath" class="form-control" readonly="readonly"/>
       					</div>
       				</div>
       				<div class="row">
       				...
       				<div class="row">
       					<div class="col-md-3 text-right">
	       					<div class="form-control-static">
	       					轮播图
	       					<input type="hidden" id="picture1Path" value="${product.productPic1Path}"  />
	       					<input type="hidden" id="picture2Path"  value="${product.productPic2Path}"/>
	       					<input type="hidden" id="picture3Path" value="${product.productPic3Path}" />
	       					</div>
	       				</div>
       					<div class="col-md-2">
       						<img  id="picture1" class="img-rounded"  src="${product.productPic1Path}" style="height:140px;width: 140px"/>
       					</div>
       					<div class="col-md-2">
       						<img  id="picture2" class="img-rounded"  src="${product.productPic2Path}" style="height:140px;width: 140px"/>
       					</div>
       					<div class="col-md-2">
       						<img  id="picture3" class="img-rounded"  src="${product.productPic3Path}" style="height:140px;width: 140px"/>
       					</div>
       				</div>
       		...
       		<div class="row">
       			...
       			<div class="col-md-8">
       				<input id="productDetail"  type="hidden" value="${product.productDetail}" />
       		...
       		<div class="row">
       			...
       			<div class="col-md-10">
       				...
       				<div class="row">
       					...
       					<div class="col-md-4">
       						<input  id="productSpecificationValue" type="text"  value="${product.productSpecificationValue}" class="form-control" placeholder="请输入相关规格" />
       				...
       				<div class="row">
       					...
       					<div class="col-md-3">
       						<input id="productStock" name="productStock" value="${product.productStock}" type="text" class="form-control"/>
       					</div>
       					<div class="col-md-3" >
       						<input id="productIsDispalyStock" name="productIsDispalyStock" type="checkbox" value="0" ${product.productIsDispalyStock==false?"checked":""}>
       						页面不显示库存数量
       					</div>
       				</div>
       ...
       <div class="container-fluid" style="background-color: rgb(244,245,249);margin:10px">
       		<div class="row">
       			...
       			<div class="col-md-10">
       				...
       				<div class="row">
	       				...
	       				<div class="col-md-2">
	       					<input id="productFreightSame" name="productFreightSame"  value="${product.productFreightSame}" type="text" class="form-control">
	       				</div>
       					...
       					<div class="col-md-2">
							  ...
							  <c:if test="${not empty LogisticsList }">
							  	<c:forEach items="${LogisticsList }" var="Logistics">
							  		 <option value="${Logistics.logisticsId}" ${product.productFreightTemplateId == Logistics.logisticsId ? "selected='selected'":""}>${ Logistics.logisticsName}</option>
							  	</c:forEach>
							  </c:if>
       				...
       				<div class="row">
       					...
       					<div class=" col-md-2">
	       					<input id="productStopbuyNum" value="${product.productStopbuyNum}" type="text" class="form-control" placeholder="0"/>
       					</div>
       				...
       				<div class="row">
	       				...
	       				<div class="col-md-2">
	       					<div class="form-control-static">
	       						<input name="productOnsaleTimeType"  type="radio" value="1" ${product.productOnsaleTimeType==1?"checked":"" }/>立即开售
	       					</div>
	       				</div>
       				...
       				<div class="row">
	       				...
	       				<div class="col-md-2 col-md-offset-3">
	       					<div class="form-control-static">
	       						<input name="productOnsaleTimeType" type="radio" value="2" ${product.productOnsaleTimeType==2?"checked":"" }/>定时开售
	       					</div>
	       				</div>
	       				<div class="col-md-3">
       				...
       				<div class="row">
	       				...
	       				<div class="col-md-2 col-md-offset-3">
	       					<div class="form-control-static">
	       						<input name="productOnsaleTimeType"  type="radio" value="3" ${product.productOnsaleTimeType==3?"checked":"" }/>放入仓库
	       					</div>
	       				</div>
       		...
       		<input name="productIntime" id="productIntime" type="hidden" value="<fmt:formatDate value='${product.productIntime}' pattern='yyyy-MM-dd HH:mm:ss'/>" />
       		<input name="productSaleNum" id="productSaleNum" type="hidden" value="${product.productSaleNum}">
			...
			$("#updateProduct").click(function(){
				...
				$('#productDetail').val(ue.getContent());
		   		jQuery.ajax({ 
                	...
                	"productIntime":$("#productIntime").val(),
                	"productSaleNum":$("#productSaleNum").val()
