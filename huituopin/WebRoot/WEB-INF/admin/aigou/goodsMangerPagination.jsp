...
<div class="pagelist">
    ...
    <input type="hidden" value="<fmt:formatDate value='${productLaunchTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" name="productLaunchTime"/>
    <input type="hidden" value="<fmt:formatDate value='${productStopTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" name="productStopTime"/>
    <input type="hidden" value="${typeSelect}" name="type"/>
