...
<html>
	...
	function ppSelectreciveInfo(shippingAddId,clothId){
		var shippingAddressList = $("#shippingAddressList").val();
		if(clothId!="other"&&clothId!=""&&shippingAddressList!=null){
			var basePath = $("#basePath").val();
			gotoNextPage(basePath+"wechat/yjya/confirmReceive",clothId,shippingAddId);
		}
	}
	
	function gotoNextPage(action,clothId,shippingAddId){
		form = $("<form></form>");
		form.attr('action',action);
		form.attr('method','post');
		input1 = $("<input type='hidden' name='clothId' />");
		input1.attr('value',clothId);
	...
	<body>
		...
		<input id="clothId" value="${type}" style="display: none"/>
		...
		<form class="mui-input-group" >
			<input id="shippingAddId" value="${shippingAddressList.shippingAddId}" style="display: none"/>
				<div class="mui-input-row1" onclick="ppSelectreciveInfo('${shippingAddressList.shippingAddId}','${type}')">
				...
				<div class="mui-input-row" style="height: 44px;">
					<div style="width: 100px;height:100%;float: left;">
						<c:choose>
							<c:when test="${shippingAddressList.shippingAddIsMain == true}">
								<div onclick="typeChange('${type}','common','pp','${shippingAddressList.userId}','${shippingAddressList.shippingAddId}')">
							...
							<c:otherwise>
								<div onclick="typeChange('${type}','default','pp','${shippingAddressList.userId}','${shippingAddressList.shippingAddId}')">
					...
					<div onclick="shipAddressDelete('${type}','pp',${shippingAddressList.userId},${shippingAddressList.shippingAddId})"  style="width: 70px;height:100%;float: right;margin-right: 10px;">
					...
					<div onclick="shipAddressEdit('${type}','pp','${shippingAddressList.shippingAddId}')" style="width: 70px;height:100%;float:right;">
