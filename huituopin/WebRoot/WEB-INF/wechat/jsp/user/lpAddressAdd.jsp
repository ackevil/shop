...
<head>
	...
	<body>
		<form method="post" class="mui-input-group" action="lpAddressAddAction"  onsubmit="return ppAddressAddAction()">
				<div class="mui-input-row">
					...
					<div class="mui-input-row" >
						...
						<input  name="shippingAddProvince"  id='showCityPicker' style="width: 72%;height: 100%;
						background-color: transparent;border: 0;text-align:right;padding-right:40px;"
						placeholder="请选择地址" readonly="readonly">				
					</div>
					<div class="mui-input-row1" style="height: 120px;" >
						<textarea name="shippingAddDetail" id="textarea" rows="5" placeholder="" style="font-size: 15px;border: 0;margin-top: 10px;"></textarea>						
					</div>									
