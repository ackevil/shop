	...
	<body>
		<ul class="mui-table-view">									
			<li class="mui-table-view-cell" style="height: 270px;padding-top: 16px;">
				<img class="mui-media-object mui-pull-left head-img" id="head-img" src="<%=path%>${productInfo[2]}" style="height: 55px;width: 55px;">
		...
		<input id="pId" type="hidden" value="${productInfo[0]}" />
		<input id="podId" type="hidden" value="${productInfo[1] }"/>
		...
		<script type="text/javascript">
	        function submmitComment(){
				...
				$.ajax({
	                ...
	                type:"POST",
	                url:"<%=basePath%>lp/submmitComment_do",
	                error:function(data){
	                    var btnArray = ["出錯了！"];
	                    mui.alert(' ',' ',btnArray, function() {
	                	});
	                ...
	                success:function(data){
	                    if (data == "true") {
		                    ...
		                    mui.alert(' ',' ',btnArray, function() {
	                         ...
	                         window.location.href="<%=basePath%>lp/lpComment";
	                    }
	                    else {
	                         var btnArray = ["出錯了！"];
		                     mui.alert(' ',' ',btnArray, function() {
