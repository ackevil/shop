...
<head>
	...
	<body>
		<form method="post" class="mui-input-group" action="ppAddressAddAction"  onsubmit="return ppAddressAddAction()">
				<div class="mui-input-row">
					<label>收货人</label>
					<input name="type" value="${type}" style="display: none;">
					<input name="userId" value="${sessionScope.user.userId}" style="display: none;">
					<input name="shippingAddName" id="receiver" type="text" placeholder="">				
					</div>
					<div class="mui-input-row" >
						<label>联系电话</label>
						<input name="shippingAddPhone" id="tel" type="text" class="mui-input-clear" placeholder="">
					</div>
					<div class="mui-input-row" >
						<label class="mui-navigate-right">所在地区</label>
						<input name="shippingAddProvince" id='showCityPicker' style="width: 72%;height: 100%;background-color: transparent;border: 0;text-align:right;padding-right:40px;" placeholder="请选择地址" readonly="readonly">				
					</div>
					<div class="mui-input-row1" style="height: 120px;" >
						<textarea name="shippingAddDetail" id="textarea" rows="5" placeholder="" style="font-size: 15px;border: 0;margin-top: 10px;" placeholder="请填写详细地址"></textarea>						
					</div>									
				<div class="login-lastline" style="padding-left: 0;padding-right: 0;padding-top: 14px;">
					<input id="save" type="submit" class="login-button" value="确认添加" style="font-size: 15px;background-color:ddarkgray;color:FC5959;"/>			
				</div>				
		</form> 
