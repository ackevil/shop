...
<head>
	...
	<body>
		<form method="post" class="mui-input-group" action="lpAddressEditAction"  onsubmit="return ppAddressAddAction()">
				<div class="mui-input-row">
					...
					<div class="mui-input-row" >
						...
						value="${shippingAddressList.shippingAddProvince}" readonly="readonly">				
					</div>
					<div class="mui-input-row1" style="height: 120px;" >
						<textarea name="shippingAddDetail" id="textarea" rows="5" placeholder="" style="font-size: 15px;border: 0;margin-top: 10px;">${shippingAddressList.shippingAddDetail}</textarea>						
					</div>									
