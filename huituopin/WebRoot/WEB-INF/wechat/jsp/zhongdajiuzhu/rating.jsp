...
<%@page import="com.huituopin.activity.entity.ActivityComment" %>
<%
                     ...
                     if (childComment.length > 0) {
                        ...
                        $.each(childComment, function(c, com) {
                            if (com.commentUserId == null) {
                                ...
                                +com.actComment
                                +"<input type='hidden' class='id' value='"+com.actCommentId+"'/>"
	   ...
	   <!--  
		...
		-->	
				...
				<div class="mui-input-row" style="height:30px;width: 70%;float: left;margin-top: 7px;">
					<input type="text" placeholder="输入内容..." id="input_comment" name="actComment">				
				</div>
				<div style="height: 100%;width: 20%;float: left;margin-top: 7px;padding-left: 10px;">
					...
					<input type="hidden" id="actCommentId" name="actCommentId" value="">
	...
	<script type="text/javascript" >
		$(function(){
			...
			$(".my_Comment").click(function(){
				...
				$("#actCommentId").val(my_Comment_id);
			...
			$("#send").click(function(){
				var actComment=$("#input_comment").val();
				var activityId=$("#activityId").val();
				var actCommentId=$("#actCommentId").val();
				...
				var commentUserAvatar=$("#commentUserAvatar").val();
		   		jQuery.ajax({ 
		   			type : "POST",
					url: "/zdjz/saveComment", 
					data: {
					"actComment":actComment,
					"activityId":activityId,
					"actCommentId":actCommentId,
					"userId":userId,
					"userName":userName,
