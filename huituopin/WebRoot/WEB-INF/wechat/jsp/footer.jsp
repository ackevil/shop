	...
	<input id="basePath" value="<%=basePath%>" style="display: none"/>
		<a href="<%=basePath%>register/" style="float: left; width: 50%;" id="home">
			<div class="icondiv" style="height:40px">
				<img id="img1" src="<%=basePath%>wechat/images/htp_light.png" class="footer" style="height:40px"/>
			</div>
		</a>
		<a id="me"  style="float: right;width: 50%;">
			<div class="icondiv" style="height:40px">
				<img id="img2" src="<%=basePath%>wechat/images/me_dark.png" class="footer1" style="height:40px"/>
			</div>
		</a>	
</body>
</html>