	    ...
	    <div class="mui-content">
	    	 <ul class="mui-table-view" style="height: 360px;"> 	
	            <a href="#" style="color: black;">
	           		<li class="mui-table-view-cell" style="height: 275px;width: 100%;padding:0;">
	                	<img src="${dsze.dszeMainPic}" style="height: 275px;width: 100%;"/>
		            </li>
        	...
        	<ul class="mui-table-view"> 	
				<li class="mui-table-view-cell"style="height: 35px;padding: 4px;font-size: 14px;">
					<a href="/dsze/detail?id=${dsze.dszeId}" class="mui-navigate-right">查看图文详情</a>
				</li>
			</ul> 
			<ul class="mui-table-view"> 	
				<li class="mui-table-view-cell"style="height: 35px;padding: 4px;font-size: 14px;">
					<a href="/dsze/rating?id=${dsze.dszeId}" class="mui-navigate-right">评论</a>
				</li>
			</ul> 
	           			...
	           			<ul class="mui-table-view" style="border-top:1px solid #CFCFCF;font-size:14px;">
							<li class="mui-table-view-cell">
								...
								<div class="right" style="margin-left:55px;">
									<span class="name">${map.get('user').getUserWcNickname()}</span><span style="font-size:13px;color:gray">支持了<span style="color:red">${map.get("dszeSupport").getDszeSupMoney()}</span>元</span><br />
									<div style="height: 9px;"></div>
									<span class='mui-ellipsis rating'>
									${map.get("dszeSupport").getDszeSupComment()}
									</span>					
								</div>	
								<div class="time">
										<fmt:formatDate value='${map.get("dszeSupport").getDszeSupTime()}' pattern="yyyy-MM-dd HH:mm:ss"/>
			...
			<form action="/wechat/pay/dszeSupport">
				<c:if test="${day==0 }">
				...
				<input type="hidden" name="id" value="${dsze.dszeId}">
			</form>
      </div>
</div>
</body>
