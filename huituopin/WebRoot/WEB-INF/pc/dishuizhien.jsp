...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function(){
				displayDsze('${requestScope.dszeList}');
				dispalyMyNav(parseInt('${requestScope.pageNum}'),1,1);
			});
			
			function displayDsze(dszeInfo){
				//在这里首先remove所有的li标签
				$("#dszeList li").remove();
				var dszeObjs = $.parseJSON(dszeInfo);
				var node = "";
				if(!dszeObjs){
					node="<li style='height: 175px; text-align:center; font-size:13px'>没有符合您搜索条件的商品</li>";
  					$("#dszeList").append(node);
				}else{
					$.each(dszeObjs,function(n,v){
		...
		<div class="box">
			<div class="top">
				...
				<div class="top_2">
					<ul>
						...
						<a href="<%=basePath%>pc/dsze"  style="color: #00BCE4;"><li>滴水之恩</li></a>
			...
			<div class="middle" style="height: 1100px;padding-top: 50px">
				<div class="middle_box">
					<div class="showarea">
						<ul id="dszeList" class="mui-table-view mui-grid-view" style="height: 850px;">
			      		</ul>
					</div>
